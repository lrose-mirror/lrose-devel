...
#include <cstring>
...

  {
    ...
    // Parameter 'dir_to_watch'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("dir_to_watch");
    tt->descr = tdrpStrDup("");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &dir_to_watch - &_start_;
    tt->single_val.s = tdrpStrDup("junk");
    tt++;
    ...
    tt->descr = tdrpStrDup("Max directory depth for search.");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Time between checks (secs).");
    tt->help = tdrpStrDup("");
