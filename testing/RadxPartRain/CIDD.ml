...
DBZ_F DBZ_F  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&DBZ_F    dbz.colors   dBZ -5 80 5 radial 1 0
VEL_F VEL_F  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&VEL_F    vel.colors   m/s -5 80 5 radial 1 0
ZDR_F ZDR_F  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&ZDR_F    zdr.colors   dB  -5 80 5 radial 1 0
SNRHC_F SNRHC_F  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&SNRHC_F    snr.colors   dB  -5 80 5 radial 1 0

NCP_F NCP_F  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&NCP_F    ncp.colors   dB  -5 80 5 radial 1 0
CMD_FLAG CMD_FLAG  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&CMD_FLAG    cmd_flag.colors   dB  -5 80 5 radial 1 0
...
DBZ4PID DBZ4PID  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&DBZ_FOR_PID    dbz.colors   dBZ -5 80 5 radial 1 0
ZDR4PID ZDR4PID  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&ZDR_FOR_PID    zdr.colors   dB  -5 80 5 radial 1 0
...
ML_EXT ML_EXT  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&ml_extended ml_flag.colors - -5 80 5 radial 1 0
CONV CONV  mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&conv_flag ml_flag.colors - -5 80 5 radial 1 0
...
DBZ_CORR2 DBZ_CORR2 mdvp:://localhost:0:$(HOME)/data/ml/test/cfradial/spol/sur&DBZ_CORR2  dbz.colors   dBZ -5 80 5 radial 1 0
=========     =========     $(HOME)/case_studies/cfradial/AD&CMD_FLAG  cmd_flag.colors   -   0 0 0   cart  1 0
=========     =========     $(HOME)/case_studies/cfradial/AD&CMD_FLAG  cmd_flag.colors   -   0 0 0   cart  1 0
...
#----------------------------------------------------------------------------
#TREC    mdvp:://tundra::dia/cfradial/ctrec/ftg&  #1 #2 None  m/s  0      yellow
...
world         world        world_states.map             2  0.0 10000.0  white
...
cidd.origin_longitude:       -99.535739
cidd.origin_latitude:        38.553164
#
#
...
# in HTML output mode.
#
cidd.level1_label:              250km
cidd.level1_min_xkm:            -250.0
cidd.level1_min_ykm:            -250.0
cidd.level1_max_xkm:            250.0
cidd.level1_max_ykm:            250.0
#
cidd.level2_label:              150km
cidd.level2_min_xkm:            -150.0
cidd.level2_min_ykm:            -150.0
cidd.level2_max_xkm:            150.0
cidd.level2_max_ykm:            150.0
#
cidd.level3_label:              100km
cidd.level3_min_xkm:            -100.0
cidd.level3_min_ykm:            -100.0
cidd.level3_max_xkm:            100.0
...
cidd.color_file_subdir:  $(HOME)/git/lrose-displays/color_scales
cidd.map_file_subdir:    $(HOME)/git/lrose-displays/maps
...
#
cidd.menu_bar_label14: SYMPRODS...
cidd.menu_bar_funct14: SHOW_PRODUCT_MENU
#
...
#
cidd.menu_bar_label9: Status...
cidd.menu_bar_funct9: SHOW_STATUS_PANEL
#
#cidd.menu_bar_label12: Print
#cidd.menu_bar_funct12: PRINT_BUTTON
#
#cidd.menu_bar_label13: Help...
#cidd.menu_bar_funct13: HELP_BUTTON
#
...
#
#cidd.menu_bar_label16: Now
#cidd.menu_bar_funct16: SET_TO_NOW
#  
...
#
#cidd.menu_bar_label20: ALL Symprods
#cidd.menu_bar_funct20: SYMPRODS_ONOFF
#
...
#
cidd.menu_bar_label13: Value
cidd.menu_bar_funct13: REPORT_MODE_ONOFF
#
...
cidd.horiz_frame_label:  **  UAE RLAN INTF **
...
prod_info = {
  { "RHI-ticks", "spdbp:Rhi2Symprod:ticks//hail::pecan/spdb/spol/rhi/sband", 0, RENDER_ALL_VALID, TRUE, 20, 10, 0.4, FALSE, FALSE}
};
